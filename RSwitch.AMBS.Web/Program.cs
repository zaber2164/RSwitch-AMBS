...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "AMBS endpoints for RSwitch", Version = "v1" });
...
builder.Services.AddDatabase(builder.Configuration).AddServices().AddRepositories().AddFluentValidators();
