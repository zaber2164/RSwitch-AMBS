//using RSwitch.AMBS.Library.pacs.paymentreversal.OrgnlTxRef;
using System;
...
namespace RSwitch.AMBS.Library.pacs.paymentreversal.OrgnlTxRef.DbtrAcct
{
    public class Id
    {
        [XmlElement(ElementName = "Othr")]
        public PaymentReversal.Othr Othr { get; set; }
    }
}
